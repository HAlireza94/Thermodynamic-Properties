...
p=3*Pc;
 ...
 q=input('Enter devides, q=');
         ...
         T_inv=Calculation_T_Inv_VTSRK_EoS_For_Pure(alpha_Function,w,Tc,Pc,T_B,Zc);
         ...
         [Pr(i), Tr(i)]=Calculation_JTIC_VTSRK_EoS_For_Pure(alpha_Function,p,Pc,Tc,T(i),w,Zc);
%          P(i)=Pc*Pr(i)*1e-05;
...
%  for j=1:q
%  
% [Pr(j,i), Tr(j,i)]=Calculation_JTIC_VTSRK_EoS_For_Pure(alpha_Function,p,Pc,Tc,T(j),w,Zc);
% 
% 
%  end
% end
