...
P=[240*101325 300*101325 360*101325];
% P=100*101325;
s1=numel(P);
...
%     for g=1:j
%     
%    [J_T(g,i,q), Speed_Sound(g,i,q), Cp(g,i,q), Cv(g,i,q)]=Caclulation_Joule_Thomson_Coefficient_SRK_EoS_For_Pure...
...
J_T(g,q)=Caclulation_Joule_Thomson_Coefficient_SRK_EoS_For_Pure...
       (alpha_function,Tc,Pc,w,T(g),P(q),A,B,C,D,E,Zc,a0);
