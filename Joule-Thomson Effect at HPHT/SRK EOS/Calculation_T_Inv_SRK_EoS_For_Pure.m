function T_inv=Calculation_T_Inv_SRK_EoS_For_Pure(alpha_Function,w,Tc,Pc,T_B,Zc)
  ...
  switch lower(alpha_Function)
    ...
    case 'ozokwelu'
        ...
        ((R*x)^2))-((b-((a*((exp(m*(1-((x/Tc)^n2))))^2))/(R*x)))/x);
