...
switch n
    ...
    case 'Ethane'
    Tc=305.3;Pc=49;w=0.099;
    case 'Propane'
    Tc=369.9;Pc=42.5;w=0.153;
    case 'Butane' 
    Tc=425.12;Pc=37.96;w=0.2;
    case 'Pentane'
    Tc=469.7;Pc=33.7;w=0.252;
    case 'Hexane'
    Tc=507.6;Pc=30.25;w=0.301;
    case 'Heptane'
    Tc=540.2;Pc=27.4;w=0.350;
    case 'Octane'
    Tc=568.7;Pc=24.9;w=0.400;
    case 'Nonane'
    Tc=594.6;Pc=22.9;w=0.444;
    case 'Decane'
    Tc=617.7;Pc=21.1;w=0.492;
    case 'eicosane'
...
%Aromatics
    ...
    case 'Benzene'
    Tc=562;Pc=48.9;w=0.212;
    case 'Toluene'
    Tc=593;Pc=41;w=0.263;
    case 'Ethyl benzene'
    Tc=617.9;Pc=37.3;w=0.302;
    case 'n-Propyl benzene' %C6H6
    Tc=638.6;Pc=32.1;w=0.3487;
    case 'n-Butyl benzene'
    Tc=660.5;Pc=28.9;w=0.394;
    case 'm-Xylene'
    Tc=618;Pc=35.4;w=0.325;
    ...
    Tc=506.85;Pc=46.91;w=0.32027;Zc=0.257;
    ...
    Tc=508.45;Pc=47.42;w=0.27596;Zc=0.257;
    case 'Ethyl ethanoate'
    Tc=523.25;Pc=38.3;w=0.36061;Zc=0.255;
...
%Ketones
    ...
    case 'Acetone' 
    Tc=508;Pc=48;w=0.304;
    case 'Methyl ethyl ketone'
    Tc=535;Pc=42;w=0.320;
    case 'Methyl n-propyl ketone'
    Tc=561.1;Pc=37;w=0.340;
    case 'Diethyl ketone'
    Tc=560.9;Pc=37.4;w=0.345;
    ...
    case 'Dimethyl ether'
    Tc=401;Pc=54;w=0.200;
    case 'Methyl ethyl ether'
    Tc=437.8;Pc=44;w=0.222;
    case 'Methyl n-propyl ether'
    Tc=476.25;Pc=38.01;w=0.272;
    case 'Diethyl ether'
    Tc=467;Pc=36;w=0.281;
    case 'Phenyl ether'
    Tc=766.8;Pc=29.58;w=0.848;

%Gases


    case 'Nitrogen'
    Tc=126.2;Pc=34;w=0.039;
    case 'Argon'
    Tc=150.86;Pc=48.98;w=0.000;
    case 'Carbon monoxide'
    Tc=134.5;Pc=35;w=0.066;
    case 'Carbon dioxide'
    Tc=304.2;Pc=73.8;w=0.239;
    case 'Carbon disulfide'
    Tc=552;Pc=79;w=0.109;
    case 'Sulfur dioxide'
    Tc=430.3;Pc=78.8;w=0.256;
    ...
    case 'Chloromethane'
    Tc=416.2;Pc=66.6;w=0.153;
    case 'Dichloromethane'
    Tc=510;Pc=63.55;w=0.199; 
    case 'Trichloromethane'
    Tc=537.00;Pc=53.30;w=0.218;
    case 'Tetrachloromethane'
    Tc=556.30;Pc=45.40;w=0.193;
    case'Chloroethane'
    Tc=460.4;Pc=52.7;w=0.191;
    case'1-Chloropropane'
    Tc=503.15;Pc=45.8;w=0.228;   
    ...
    case 'Methanol'
    Tc=513;Pc=81;w=0.556;
    case 'Ethanol'
    Tc=514;Pc=63;w=0.644;
    case '1-Propanol'
    Tc=536.78;Pc=51.68;w=0.62;
    case '1-Butanol'
    Tc=563.05;Pc=44.24;w=0.591;
    case '1-Pentanol'
    Tc=588.1;Pc=38.97;w=0.573;
    case '1-Hexanol'
    Tc=610.3;Pc=34.17;w=0.576;
    case '1-Heptanol'
    Tc=632.6;Pc=30.58;w=0.567;
    case '1-Octanol'
    Tc=652.5;Pc=27.77;w=0.583;
    case '1-Nonanol'
    Tc=670.7;Pc=25.28;w=0.600;
    case '1-Decanol'
    Tc=687.3;Pc=23.15;w=0.622;
    case '2-Propanol'
    Tc=508.3;Pc=47.62;w=0.665;
    case '2-Butanol'
    Tc=536.00;Pc=44.2;w=0.578;
    case '2-Methyl-1-propanol'
    Tc=547.70;Pc=43.00;w=0.586;
    case '2-Methyl-2-propanol'
    Tc=506.2;Pc=39.7;w=0.614;
    case 'Phenol'
    ...
    case 'R11'
        Tc=471.2;Pc=44.08;w=0.189;
    case 'R113'
        Tc=487.25;Pc=34.1;w=0.252;
    case 'R114'
        Tc=410.78;Pc=28.17;w=0.268;
    case 'R115'
        Tc=353.15;Pc=31.57;w=0.251;
    case 'R116'
        Tc=292.8;Pc=29.8;w=0.249;
    case 'R12'
        Tc=384.95;Pc=41.25;w=0.18;
    case 'R123'
        Tc=456.94;Pc=33.76;w=0.282;
    case 'R124'
        Tc=395.65;Pc=36.6;w=0.288;
    case 'R125'
        Tc=339.17;Pc=36.2;w=0.305;
    case 'R13'
        Tc=301.8;Pc=38.7;w=0.172;
    case 'R134a'
        Tc=374.18;Pc=40.56;w=0.327;
    case 'R14'
        Tc=227.5;Pc=37.4;w=0.179;
    case 'R141b'
        Tc=478.85;Pc=43.4;w=0.221;
    case 'R142b'
        Tc=410.29;Pc=40.41;w=0.231;
    case 'R143a'
        Tc=345.88;Pc=37.64;w=0.261;
    case 'R152a'
        Tc=386.44;Pc=45.2;w=0.275;
    case 'R21'
        Tc=451.58;Pc=51.84;w=0.205;
    case 'R218'
        Tc=345.05;Pc=26.8;w=0.327;
    case 'R22'
        Tc=369.3;Pc=49.71;w=0.219;
    case 'R227ea'
        Tc=374.83;Pc=28.45;w=0.367; 
    case 'R23'
        Tc=299.01;Pc=48.16;w=0.264;
    case 'R236ea'
        Tc=412.38;Pc=34.2;w=0.369;
    case 'R236fa'
        Tc=398.07;Pc=32.00;w=0.321;
    case 'R245ca'
        Tc=444.57;Pc=39.41;w=0.355;
    case 'R245fa'
        Tc=427.16;Pc=36.51;w=0.33;
    case 'R32'
        Tc=351.26;Pc=57.84;w=0.227;
    case 'R41'
        Tc=317.42;Pc=58.75;w=0.198;
    case 'RC318'
        Tc=388.37;Pc=27.78;w=0.356;
        
    case 'R31'
        Tc=411.48;Pc=80.04;w=0.155;
...
P=1e-07;
R=83.14472;a=(0.45724*(R^2)*(Tc^2))/Pc;b=(0.07780*R*Tc)/Pc;
Tpt=Tc*(0.2498+(0.3359*w)-(0.1037*w^2));
bpt=b*(1-(0.1519*w)-(3.9462*w^2)+(7.0538*w^3));
apt=R*Tpt*bpt*29.7056;

k=((apt/a)^0.5)-1;
Z=input('Enter Initial Guess For Comperssibility Of Gas, Z=');
T=input('Enter Initial Guess For Temperature Of Gas, T=');
PARA0=[Z,T];
  

[X,fval,exitflag,output]=Objective_Nasrifar(P,R,Tc,a,b,k,Tpt,PARA0);
