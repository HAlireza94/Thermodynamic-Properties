...
% Tc=190.56;Pc=45.99200;w=0.011;Zc=0.2863; %Methane1
...
% Tc=405.65;Pc=112.8;w=0.2526;Zc=0.242; %Ammonia
  ...
  Tc=373.53;Pc=89.63;w=0.0942;Zc=0.284; %Hydrogen sulfide

R=83.14472;P=0.01*Pc;
...
% x2=input('Enter uper range of temperature, T2=');
 ...
 T=linspace(Tc,2000,100)';n=numel(T);
