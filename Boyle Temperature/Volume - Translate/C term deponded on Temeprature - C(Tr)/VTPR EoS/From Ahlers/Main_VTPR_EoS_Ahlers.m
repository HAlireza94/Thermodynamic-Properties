...
P=1e-07;
R=8.314472;a=(0.45724*(R^2)*(Tc^2))/Pc;b=(0.07780*R*Tc)/Pc;
Cc=(0.3074-Zc)*((R*Tc)/Pc);
Etta=(246.78*Zc^2)-(107.21*Zc)+12.67;
Gamma=26.966-(74.458*Zc);
...
[X,fval,exitflag,output]=Objective_Ahlers(P,R,Tc,a,b,k,Cc,Etta,Gamma,PARA0);
...
% (Cc*(0.35/(0.35+((Etta*(abs((PARA0(2)/Tc)-((1+(k*(1-((PARA0(2)/Tc)^0.5))))^2))))^Gamma))))
