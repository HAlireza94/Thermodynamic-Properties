...
for i=1:n
    ...
    Delta_Internal_Energy(i,j)=((((DEI(i,j))/(2*sqrt(2)*b(j))))*...
      ...
      SV(i,j)=(0.077796*((R*Tc(j))/Pc(j)))-((((0.457235*(R^2)*(Tc(j)^2))/Pc(j))*...
        ((1+((0.37464+(1.54226*w(j))-(0.26992*(w(j))^2))*(1-(T(i)/Tc(j))^0.5)))^2))/(R*T(i)));
    ...
    X20(i,j)=5.210420936472946*X18(i,j);
